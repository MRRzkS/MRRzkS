...
<table>
  <tr>
    ...
    <td>
      ...
      <img src="https://img.shields.io/badge/BullMQ-EA2027?style=flat-square" />
...
| :--- | :--- | :--- |
| [Hidden Fluid Mechanics](https://github.com/MRRzkS/hidden-fluid-mechanics-pinn) | Reconstructs an unobserved pressure field from velocity data alone, supervised only by the Navier-Stokes residual | PyTorch |
| [CatatStok](https://github.com/MRRzkS/CatatStock) | Desktop inventory management application, built as primary developer | Java, JavaFX, Maven |
| [Bron-Kerbosch Visualizer](https://github.com/MRRzkS/Maximum-Clique-using-Bron-Kerbosch-Algorithm) | Step by step maximum clique visualizer with pseudocode highlighting and a live recursion stack | Python, Pygame |
